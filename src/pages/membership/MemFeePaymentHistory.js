...
const MemFeePaymentHistory = (props) => {
  ...
  const fetchMemFeeList = async () => {
    const { data } = await getPaidMemFee({
      params: {
  ...
  const columns = [
    ...
    { id: 'date', label: 'Effective From', minWidth: 100, align: 'center' },
    { id: 'paymentId', label: 'Payment Id', minWidth: 100, align: 'center' },
    { id: 'referenceNo', label: 'Reference No.', minWidth: 100, align: 'center' },
...
export default MemFeePaymentHistory;